...
{
    public float rotationSpeed = 180f; // public = exposed to Unity inspector
    ...
    void Update()
    {
        ...
        //transform.Rotate( 0, 0, verticalMouseSpeed * Time.deltaTime * rotationSpeed); // FRAMERATE INDEPENDENT because we use Time.deltaTime
